...
const FeatureInfoDownloadRosa = createReactClass({
  // propTypes: {
  ...
  getLinks() {
    //console.log('FeatureInfoDownloadMio getLinks this.props.data',this.props.data)
    return [
      {
...
export default withTranslation()(FeatureInfoDownloadRosa);
