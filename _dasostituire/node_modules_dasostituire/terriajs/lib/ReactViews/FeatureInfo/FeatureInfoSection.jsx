...
import RosaventoContainer from '../../../../../lib/Views/components/RosaventoARFContainer';
...
export const FeatureInfoSection = observer(
  createReactClass({
    ...
    render() {
      const { t } = this.props;
      // console.log('FeatureInfoSection')
      // console.log(this.props)
      // console.log(this.props.feature)
            // console.log(this.props.feature._data)
            // console.log(this.props.feature._data.id, this.props.feature._data.properties.id_cella)
            // console.log(this.props.feature._data.properties.quota, this.props.feature._data.properties.vento_50)
 ...
 */
FeatureInfoSection.extraComponents = [RosaventoContainer];
