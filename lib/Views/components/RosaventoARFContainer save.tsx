...
import TabFrequenzeRosa from "./TabFrequenzeRosa2";
    ...
    if (renderOK) {
      return (
        ...
        >
          ...
          {/* <p>cliccare sul grafico per {(mostraTabella)?'nascondere':'mostrare'} la tabella delle frequenze</p> */}
          <p>
            {mostraTabella
              ? t("rosaDeiVenti.msgNascondi")
              : t("rosaDeiVenti.msgMostra")}
          </p>
          <TabFrequenzeRosa mostra={mostraTabella} datirosa={datirosa} />
        </div>
      );
    } else {
      return <div></div>;
