...
// con FC NON funziona xchè la compatibilità delle props non è completa
type Props_RosaventoContainer = {
  props: {
    viewState: any;
    template: any;
    feature: {
    ...
    position: any;
    catalogItem: { uniqueId: any; name: any };
  };
};
...
const RosaventoContainer: FC<Props_RosaventoContainer> = ({ props }) => {
  ...
  console.log(
    "idpunto level catalogItemName onshore",
    numidRosa,
    numlevel,
    catalogItemName,
    onshore
