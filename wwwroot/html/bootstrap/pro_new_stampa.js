...
function setURLParam() {
	...
	if (KWe[0] == 0) { KWe[0] = KWe[2]}  //se manca Kweibull@50m prendo il valore a 100
	if (KWe[1] == 0) { KWe[1] = KWe[2]}
  // console.log(VelMed)
  // console.log(Produc)
  // console.log(KWe)
...
//fine combo ---------------------------------------------------------------------------
	...
	str = __("Atlas value : ") + KWeib;
	console.log("combo   ",KWeib); 
	console.log("combostr   ",str); 
	$("#labKWeibullAtl").html(str);
